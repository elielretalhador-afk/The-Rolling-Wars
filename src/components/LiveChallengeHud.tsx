...
export const LiveChallengeHud: React.FC<LiveChallengeHudProps> = ({
  ...
  const getRankBadge = (index: number) => {
    ...
    return (
      <span className="px-1.5 py-0.5 rounded bg-white/10 border border-white/20 text-neutral-300 font-mono-stat font-bold text-[9px]">
        {index + 1}º
      </span>
    );
  };
  ...
  return (
    ...
    >
      <div className="bg-[#090d14]/95 border-2 border-yellow-400/60 rounded-2xl shadow-[0_0_30px_rgba(0,255,102,0.25)]  overflow-hidden transition-all duration-300">
        {/* Header Compacto */}
        <div className="px-3.5 py-2.5 bg-gradient-to-r from-emerald-950/80 via-[#0b131e] to-black border-b border-yellow-400/30 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            {onCancelChallenge && (
              <button
                ...
                className="p-1 rounded-lg hover:bg-red-500/20 text-neutral-400 hover:text-red-400 transition-all cursor-pointer"
        ...
        {/* Informações da Rota */}
        <div className="px-3.5 py-1.5 bg-black/40 border-b border-white/5 flex items-center justify-between text-[10px] text-neutral-300 font-mono-stat">
          <span className="truncate text-neutral-300 font-bold">
            📍 {challenge.routeName}
          </span>
            ...
            {sortedParticipants.map((p, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-1 pt-1 border-t border-white/5 text-[10px] font-mono-stat text-neutral-300">
                    <div className="flex items-center gap-1">
            ...
            <div className="pt-2 border-t border-white/10 flex items-center justify-between gap-2">
              ...
              {onFinishChallenge && (
                <button
                  ...
                  className="flex-1 py-1.5 px-2.5 rounded-xl bg-yellow-400 hover:bg-emerald-300 text-black font-black text-[11px] uppercase font-mono-stat tracking-wider shadow-[0_0_15px_rgba(0,255,102,0.4)] flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                >
