      ...
      >
        ...
        <div className="relative shrink-0">
          <img
            src={user.avatar}
            alt={user.nickname}
            className="w-10 h-10 rounded-xl object-cover border-2 border-yellow-400 shadow-[0_0_12px_rgba(0,255,102,0.35)]"
          />
        ...
        <div className="flex flex-col justify-center min-w-0 pr-1">
          ...
          <div className="mt-1 flex items-center gap-1.5 w-24 sm:w-28">
            ...
            <span className="text-[8px] font-mono-stat font-black text-neutral-400 shrink-0 leading-none">
              {xpPercent}%
            </span>
          </div>
        </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        ...
        {onOpenSearch && (
          <button
            ...
            className="relative p-2 rounded-xl bg-[#0a0a0a] hover:bg-[#182330] border border-white/10 hover:border-yellow-400/50 text-neutral-300 hover:text-yellow-400 shadow-[0_2px_8px_rgba(0,0,0,0.5)] active:scale-95 transition-all cursor-pointer"
            title="Busca e Descoberta Global"
            aria-label="Buscar Jogadores, Zonas e Rotas"
          >
            <Search className="w-4 h-4 text-neutral-300 group-hover:text-yellow-400" />
          </button>
        )}
        ...
        {onOpenActivityFeed && (
          <button
            ...
            className="relative p-2 rounded-xl bg-[#0a0a0a] hover:bg-[#182330] border border-white/10 hover:border-cyan-400/50 text-neutral-300 hover:text-cyan-400 shadow-[0_2px_8px_rgba(0,0,0,0.5)] active:scale-95 transition-all cursor-pointer"
            title="Feed & Central de Atividades"
            aria-label="Abrir Feed de Atividades"
          >
            <Activity className="w-4 h-4 text-neutral-300 group-hover:text-cyan-400" />
          </button>
        )}
        ...
        <button
          ...
          className="relative p-2 rounded-xl bg-[#0a0a0a] hover:bg-[#182330] border border-white/10 hover:border-yellow-400/50 text-neutral-300 hover:text-white shadow-[0_2px_8px_rgba(0,0,0,0.5)] active:scale-95 transition-all cursor-pointer"
          title="Central de Notificações"
          aria-label="Abrir Notificações"
        >
          <Bell className="w-4 h-4 text-neutral-300 hover:text-white" />
          {unreadNotificationsCount > 0 && (
            <span className="absolute -top-1 -right-1 flex h-4 min-w-[16px] px-1 items-center justify-center rounded-full bg-yellow-400 text-black text-[9px] font-black font-mono-stat border border-black shadow-[0_0_10px_#00ff66] animate-pulse">
        ...
        {onOpenSettings && (
          ...
          >
            <Settings className="w-4 h-4 text-neutral-300 group-hover:text-yellow-400" />
          </button>
        )}
      </div>
    </header>
