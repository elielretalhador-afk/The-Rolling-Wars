#!/bin/bash
sed -i '/<div className="absolute inset-0 flex items-center justify-between px-1"/,/<div className="w-16 h-16 rounded-full border-4 border-\[#fce803\]\/20/c\
          ...
          <div className="w-16 h-16 rounded-full border-4 border-[#fce803]/20' src/App.tsx
